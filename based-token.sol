...
contract BasedToken is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    function claimReward() public {
        require(!blacklisted[msg.sender], "BasedToken: User is blacklisted");
        require(block.timestamp >= lastClaim[msg.sender] + 1 days, "BasedToken: Can only claim once per day");

        // Mint small reward (10 tokens)
    ...
    function _update(
        ...
        require(!blacklisted[from], "BasedToken: Sender is blacklisted");
        require(!blacklisted[to], "BasedToken: Receiver is blacklisted");
